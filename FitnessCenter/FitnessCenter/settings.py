...
MIDDLEWARE = [
    ...
    'centerHandling.middlewares.UpdateAuthTokenMiddleware'
]
...
if DEVELOPMENT_MODE:
    ...
    BACKEND_SSO_SERVICE_DOMAIN='sso-sso-1'
    BACKEND_SSO_SERVICE_PORT=8000
else:
    BACKEND_SSO_SERVICE_PROTOCOL=getenv('BACKEND_SSO_SERVICE_PROTOCOL', 'http')
    BACKEND_SSO_SERVICE_DOMAIN=getenv('BACKEND_SSO_SERVICE_DOMAIN','sso-sso-1')
