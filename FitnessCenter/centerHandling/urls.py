...
urlpatterns = [
    ...
    path('availability/<str:type>/<str:date>/<str:duration>/<str:center_uuid>', AvailabilityView.as_view(), name = 'availability-views'),
    path('availability/<str:type>/<str:date>/<str:duration>/<str:center_uuid>/<str:employee_uuid>', AvailabilityView.as_view()),
